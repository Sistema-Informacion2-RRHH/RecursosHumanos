...
<div class="container">
    <div class="row">
        ...
        {!!Form::open( array('url'=>'seleccion','method'=>'POST','autocomplete'=>'off') )!!}
        {!!Form::token()!!} 

        <div class="form-group">
        <label form="Recomendacion">RECOMENDACION</label>
        <input type="text" name="Recomendacion" class="form-control" placeholder="juan" required>
        </div>
        <div class="form-group">
        <label form="Puntuacion">PUNTUACION</label>
        <input type="number" name="Puntuacion" class="form-control" placeholder="0" required>
        </div>

      <div class="form-group">
        <label form="id">POSTULANTE RECLUTADO</label>
